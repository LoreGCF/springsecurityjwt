...
public class PrincipalController {
    ...
    //se implementa para complementar el algoritmo de encriptacion de SecurityConfig
    @Autowired
    ...
    public ResponseEntity<?> createUser(@Valid @RequestBody CreateUserDTO createUserDTO){
        ...
        UserEntity userEntity = UserEntity.builder()
                ...
                /*con esta configuracion en password cuando se incerte en la 
base de datos va a tener todos los caracteres de la encriptacion*/
